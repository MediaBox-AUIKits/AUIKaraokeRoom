...
public class KTVRoomService {
    ...
    public static Observable<Integer> joinMic(ARTCKaraokeRoomController roomController, boolean microphoneSwitch) {
...
//                        rs.agree = true;
                    ...
                    public void onJoinedMic(UserInfo user) {
                        ...
                        if(user.equals(roomController.getCurrentUser())) {
                            emitter.onNext(KTVRoomManager.CODE_SUCCESS);
                            emitter.onComplete();
                            roomController.removeObserver(this);
                        }
                    }
    ...
    public static Observable<Integer> leaveMic(ARTCKaraokeRoomController roomController) {
        return Observable.create(new ObservableOnSubscribe<Integer>() {
            @Override
            public void subscribe(@NonNull ObservableEmitter<Integer> emitter) throws Throwable {
                ChatRoomCallback roomCallback = new ChatRoomCallback() {
    ...
    public static Observable<Integer> joinRoom(ARTCKaraokeRoomController roomController, RoomInfo roomInfo, RtcInfo rtcInfo) {
    ...
    public static Observable<Integer> exitRoom(ARTCKaraokeRoomController roomController, boolean isCompere) {
        return Observable.create(new ObservableOnSubscribe<Integer>() {
                    @Override
                    public void subscribe(@NonNull ObservableEmitter<Integer> emitter) throws Throwable {
                        if(isCompere) {
