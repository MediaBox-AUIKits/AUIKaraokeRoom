...
import com.aliyun.auikits.ktv.databinding.KtvDialogInputMsgBinding;
...
public class InputTextMsgDialog extends Dialog {
    ...
    private KtvDialogInputMsgBinding binding;
//    private LinearLayout mConfirmArea;
    ...
    public InputTextMsgDialog(@NonNull Context context) {
        ...
        binding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.ktv_dialog_input_msg, null, false);
