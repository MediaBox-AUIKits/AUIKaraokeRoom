...
public class ChatMember implements Serializable {
    ...
    /** 演唱标记: 没有演唱 **/
    public static final int SINGER_FLAG_NONE = 0;
    /** 演唱标记: 主唱人 **/
    public static final int SINGER_FLAG_LEAD = 1;
    /** 演唱标记: 合唱人 **/
    public static final int SINGER_FLAG_JOIN = 2;
    ...
    /** 演唱标记 */
    private int mSingerFlag = SINGER_FLAG_NONE;
    ...
    public void setSingerFlag(int mSingerFlag) {
        this.mSingerFlag = mSingerFlag;
    }
