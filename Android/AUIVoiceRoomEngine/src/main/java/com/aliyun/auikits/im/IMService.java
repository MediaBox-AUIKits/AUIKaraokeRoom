...
public class IMService {
    ...
    //发送群组消息
    public int sendGroupMessage(String groupId, int msgType, String json, boolean skipAudit, boolean noStorage) {
        ...
        sendReq.data = json;
        sendReq.skipAudit = skipAudit;
        sendReq.noStorage = noStorage;
    ...
    //发送个人定向消息
    public int sendMessage(String groupId, String userId, int msgType, String json, boolean skipAudit, boolean noStorage) {
